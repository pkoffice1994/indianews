...
class News(models.Model):
    ...
    title_hi    = models.CharField("Title (Hindi)*", max_length=500)
    summary_hi  = models.TextField("Summary (Hindi)", blank=True)
    content_hi  = models.TextField("Content (Hindi)*")
    ...
    featured_image     = models.ImageField("Featured Image", upload_to='news/%Y/%m/', blank=True, null=True)
    featured_image_url = models.URLField("Featured Image URL", blank=True)
